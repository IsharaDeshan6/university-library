...
import learnway.view.admin.dashboard.components.CompoundIcon;
import learnway.view.admin.dashboard.forms.AdminDetails;
...
import learnway.view.admin.dashboard.forms.ReadForm;
...
//                     FormManager.showForm(new AdminDetails());
                    }else if(index[1] == 2){
